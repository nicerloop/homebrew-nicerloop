class AcloudguruSandbox < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/nicerloop/acloudguru-sandbox/releases/download/v0.0.1/acloudguru-sandbox_Darwin_x86_64.tar.gz"
      sha256 "caf9c31384cb757b1af47bcc0b8fb7934a6fb9e08e30730bcde083e35504cdf4"
    end
    if Hardware::CPU.arm?
      url "https://github.com/nicerloop/acloudguru-sandbox/releases/download/v0.0.1/acloudguru-sandbox_Darwin_arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/nicerloop/acloudguru-sandbox/releases/download/v0.0.1/acloudguru-sandbox_Linux_arm64.tar.gz"
      sha256 "02d4d8e39bf3ec35c9532d0717574288ae23923d751e6388a8e0e57a77119d55"
    end
    if Hardware::CPU.intel?
      url "https://github.com/nicerloop/acloudguru-sandbox/releases/download/v0.0.1/acloudguru-sandbox_Linux_x86_64.tar.gz"
