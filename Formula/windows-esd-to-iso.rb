class WindowsEsdToIso < Formula
  ...
  homepage "https://github.com/mattieb/windows-esd-to-iso"
  url "https://github.com/mattieb/windows-esd-to-iso/archive/f16d832b610a6f83b3adef6e1d425ee1a7674fa4.tar.gz"
  version "2024-01-25"
