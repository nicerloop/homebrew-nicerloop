class FortranIos < Formula
  ...
  version "2.3"
  on_intel do
    url "https://github.com/ColdGrub1384/fortran-ios/releases/download/v#{version}/fortran-ios-macos-86_64.zip"
    sha256 "a311dd2f91859384a8a4d38ed2a204219c9122db9d76f06500316292c751afc3"
  end
  on_arm do
    url "https://github.com/ColdGrub1384/fortran-ios/releases/download/v#{version}/fortran-ios-macos-arm64.zip"
