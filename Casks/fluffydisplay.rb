cask "fluffydisplay" do
  ...
  url "https://github.com/tml1024/FluffyDisplay/releases/download/#{version.csv.first}(#{version.csv.second})/FluffyDisplay-#{version.csv.first}.#{version.csv.second}.zip"
  name "FluffyDisplay"
